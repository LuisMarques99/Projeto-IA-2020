...
/**
 * Esta é a classe onde se irá desenvolver o robot com a capacidade de movimentacao autonoma
 * Implementacao do algoritmo genético é feita neste robot
 * Utilizado o codigo relativo ao AdvancedWalkerRobot como base ao funcionamento deste robot!
 */
public class MARK1 extends AdvancedRobot {
    /*
